<script type="text/javascript">
    function initialize_<?php echo esc_js($gmap_name) ?>() {
        ...
        // do not activate pin rendering on post menu or on small map on main menu
        if(esc_js($gmap_name) != 'postmenumap' and esc_js($gmap_name) != 'gmapmainmenusmall') {
        ?>
